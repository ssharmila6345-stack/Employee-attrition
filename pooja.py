...
try:
    ...
    if selected_page == "📊 Overview":
        ...
        with col2:
            ...
            fig = px.line(age_attrition, x='Age_Group', y='rate', 
            ...
            fig = px.bar(promo_attrition, x='Promotion_Last_5Years', y='rate',
        ...
        with tab1:
            ...
            with col1:
                ...
                fig = px.box(filtered_data, x='Age', y='Attrition_Leval', 
        ...
        with tab3:
            ...
            with col2:
                ...
                # Scatter plot: Satisfaction vs Hours
                fig = px.scatter(filtered_data, x='Satisfaction_Level', y='Average_Monthly_Hours',
                                 color='Attrition_Label', opacity=0.6,
                                 title='Satisfaction Level vs Monthly Hours',
                                 color_discrete_map={'Yes': 'red', 'No': 'blue'})
                st.plotly_chart(fig, use_container_width=True)
        ...
        with tab4:
            ...
            with col2:
                ...
                fig = px.scatter(filtered_data, x='Salary', y='Satisfaction_Level',
                                 color='Attrition_Label', size='Average_Monthly_Hours',
                                 title='Salary vs Satisfaction Level',
                                 color_discrete_map={'Yes': 'red', 'No': 'blue'})
                st.plotly_chart(fig, use_container_width=True)
